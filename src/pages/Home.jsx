              ...
              <Row>
                <Col lg={4}>
                  <div className="bg-[#fff] picture-box p-[1.6rem] rounded-[16px] shadow-css-2 relative transitions overflow-hidden">
                    ...
                    <LazyLoadImage src={nicat} className='rounded-[8px] h-[500px] w-full' />
                      <figcaption className='figcaption bg-[--color1]  absolute bottom-[0] left-[0] w-[90%] h-[90%] text-center rounded-[8px] opacity-[0] pt-[.8rem] pb-[.8rem] z-[3] transition2'>
                        <div className="absolute bottom-[5px] z-[99] w-full text-left pt-[1.5rem] pb-[1.5rem] pl-[2rem] pr-[2rem]">
                          <h3 className='text-[2rem] text-[#fff] font-[600] '>Nicat</h3>
                          <span className='text-[#fff] uppercase'>Qrupun təsisçisi</span>
                        </div>
                      </figcaption>
                    </figure>
                  </div>
                ...
                <div className="bg-[#fff] picture-box p-[1.6rem] rounded-[16px] shadow-css-2 relative transitions overflow-hidden">
                    <figure className='figure relative m-0 '>
                    <LazyLoadImage src={emil} className='rounded-[8px] h-[500px] w-full' />
                      <figcaption className='figcaption bg-[--color1] absolute bottom-[0] left-[0] w-[90%] h-[90%] text-center rounded-[8px] opacity-[0] pt-[.8rem] pb-[.8rem] z-[3] transition2'>
                        <div className="absolute bottom-[5px] z-[99] w-full text-left pt-[1.5rem] pb-[1.5rem] pl-[2rem] pr-[2rem]">
                          <h3 className='text-[2rem] text-[#fff] font-[600] '>Emil</h3>
                          <span className='text-[#fff] uppercase'>Öz Admin</span>
                        </div>
                      </figcaption>
                    </figure>
                  </div>
                ...
                <div className="bg-[#fff] picture-box p-[1.6rem] rounded-[16px] shadow-css-2 relative transitions overflow-hidden">
                    <figure className='figure relative m-0 '>
                    <LazyLoadImage src={user} className='rounded-[8px] h-[500px] w-full' />
                      <figcaption className='figcaption bg-[--color1] absolute bottom-[0] left-[0] w-[90%] h-[90%] text-center rounded-[8px] opacity-[0] pt-[.8rem] pb-[.8rem] z-[3] transition2'>
                        <div className="absolute bottom-[5px] z-[99] w-full text-left pt-[1.5rem] pb-[1.5rem] pl-[2rem] pr-[2rem]">
                          <h3 className='text-[2rem] text-[#fff] font-[600] '>Mədinə</h3>
                          <span className='text-[#fff] uppercase'>Baş Admin</span>
                        </div>
                      </figcaption>
                    </figure>
                  </div>
